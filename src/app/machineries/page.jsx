    ...
    return (
        ...
        >
            <motion.h3
                ...
                className="relative w-fit text-2xl font-bold text-gray-600 p-6 text-center border-b-2 border-green-400 hover:shadow-md hover:shadow-green-500 rounded-full transition-all duration-300 group"
            >
                {title}
                <span className="absolute inset-0 bg-green-200 left-0 w-full h-full transition-all duration-300 ease-in-out transform scale-x-0 group-hover:scale-x-100 origin-left z-0"></span>
